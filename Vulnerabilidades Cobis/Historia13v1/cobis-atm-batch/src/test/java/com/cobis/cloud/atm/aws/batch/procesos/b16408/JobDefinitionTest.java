package com.cobis.cloud.atm.aws.batch.procesos.b16408;
...
import com.cobiscorp.businesslogic.atm.BL_extraccion_infor_pasivas;
...
class JobDefinitionTest {
	...
	com.cobis.cloud.atm.aws.batch.procesos.b16408.JobDefinition jobDefinition;
	...
	void testGetBusinessLogicProgram(){
		//Valor esperado
		IBusinessLogic iBusinessLogicExpected = new BL_extraccion_infor_pasivas();
